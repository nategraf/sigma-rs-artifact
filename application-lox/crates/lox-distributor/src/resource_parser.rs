...
use lox_extensions::bridge_table::{BridgeLine, BRIDGE_INFO_BYTES, MAX_BRIDGES_PER_BUCKET};
...
pub fn parse_into_bridgelines(
    ...
    for resource in resources {
        ...
        let unhashed_fingerprint: [u8; 20] = array_bytes::hex2array(&resource.fingerprint)
